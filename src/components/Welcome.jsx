...
const Welcome = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    requestAnimationFrame(() => {
      ...
      // Set canvas dimensions after layout is complete
      canvas.width = window.innerWidth;
      canvas.height = window.innerHeight;
    ...
    <div className={`welcome-container ${!isVisible ? 'fade-out' : ''}`}>
      ...
      <style jsx>{`
        ...
        .neural-canvas {
          ...
          z-index: 1;
          opacity: 0;
          animation: fade-in-canvas 0.5s ease-out 0.1s forwards;
        }
        ...
        .brand-name {
          ...
          background-clip: text;
          color: transparent;
          animation: gradient-shift 3s ease infinite, fade-in-up 0.8s ease-out 0.2s backwards;
